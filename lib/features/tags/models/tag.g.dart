...
Tag _tagDeserialize(
  ...
  final object = Tag(
    ...
    id: id,
    isEditable: reader.readBoolOrNull(offsets[1]) ?? true,
...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> isEditableEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension TagQuerySortBy on QueryBuilder<Tag, Tag, QSortBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> sortByIsEditable() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEditable', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> sortByIsEditableDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQuerySortThenBy on QueryBuilder<Tag, Tag, QSortThenBy> {
  ...
  QueryBuilder<Tag, Tag, QAfterSortBy> thenByIsEditable() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEditable', Sort.asc);
    });
  }

  QueryBuilder<Tag, Tag, QAfterSortBy> thenByIsEditableDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEditable', Sort.desc);
    });
  }
...
extension TagQueryWhereDistinct on QueryBuilder<Tag, Tag, QDistinct> {
  ...
  QueryBuilder<Tag, Tag, QDistinct> distinctByIsEditable() {
    return QueryBuilder.apply(this, (query) {
...
extension TagQueryProperty on QueryBuilder<Tag, Tag, QQueryProperty> {
  ...
  QueryBuilder<Tag, bool, QQueryOperations> isEditableProperty() {
    return QueryBuilder.apply(this, (query) {
